...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl flex items-center justify-center font-bold text-primary-foreground gradient-primary text-sm shadow-sm", children: "OP" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "Only Pals" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Every child deserves to be understood, not just seen." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center gap-6 text-sm text-muted-foreground", children: ["Brand Essence", "Campaign", "Trust & Safety"].map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => {
              var _a2;
              return (_a2 = document.getElementById(
                label.toLowerCase().replace(/[& ]+/g, "-").replace(/-+/g, "-")
              )) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
            },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center md:text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "© ",
          year,
...
function useScrollSpy(sectionIds2, offset = 80) {
  const [activeId, setActiveId] = reactExports.useState(sectionIds2[0] ?? "");
  reactExports.useEffect(() => {
    const handleScroll = () => {
      const scrollY = window.scrollY + offset + 10;
      let current = sectionIds2[0] ?? "";
      for (const id of sectionIds2) {
...
function Navigation() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      "data-ocid": "nav",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-4 flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl flex items-center justify-center text-lg font-bold text-primary-foreground gradient-primary shadow-sm", children: "OP" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-lg text-foreground", children: [
                  "Only",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: " Pals" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "nav",
            {
              ...
              children: [
                NAV_ITEMS.slice(0, 9).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => scrollTo(item.href),
                    "data-ocid": `nav-${item.id}`,
                    className: `px-3 py-1.5 rounded-lg text-xs font-medium transition-smooth whitespace-nowrap ${activeId === item.id ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                    children: item.label
                  },
                  item.id
                )),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-card/98 backdrop-blur-md border-t border-border px-4 py-4 grid grid-cols-2 gap-1.5 max-h-[80vh] overflow-y-auto", children: NAV_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(item.href),
            "data-ocid": `mob-nav-${item.id}`,
            className: `px-3 py-2.5 rounded-xl text-sm font-medium text-left transition-smooth ${activeId === item.id ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
            children: item.label
          },
          item.id
        )) })
...
const traits = [
  { label: "Warm", color: "primary" },
  { label: "Playful", color: "warm" },
  { label: "Trustworthy", color: "secondary" },
  { label: "Wise", color: "accent" },
  { label: "Inclusive", color: "secondary" }
];
const toneCards = [
  {
...
function BrandAvatarSection() {
  const { ref: heroRef, isVisible: heroVisible } = useFadeIn();
  const { ref: quoteRef, isVisible: quoteVisible } = useFadeIn();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "brand-avatar", className: "py-24 px-4 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "primary", children: "Brand Avatar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-6xl text-foreground mt-4 mb-4", children: [
        "Meet ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "The Warm Guide" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "A personality built on empathy, safety, and pure childhood joy." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: heroRef,
        className: `grid md:grid-cols-2 gap-10 items-center mb-16 transition-all duration-700 ease-out ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-72 h-72 md:w-80 md:h-80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full gradient-primary p-1 shadow-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full rounded-full overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 bg-card border border-border rounded-2xl px-4 py-2 shadow-md whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm text-primary", children: "✨ The Warm Guide" }) })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Personality Traits" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: traits.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Tone of Voice" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: toneCards.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: `flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r ${card.gradient} border border-border`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl flex-shrink-0", children: card.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base", children: card.phrase }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: card.desc })
                    ] })
                  ]
                },
                card.phrase
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        ref: quoteRef,
        className: `transition-all duration-700 delay-200 ease-out ${quoteVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "blockquote",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-4 left-6 text-5xl text-primary/20 font-serif leading-none select-none", children: '"' }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "italic font-body text-xl md:text-2xl text-foreground leading-relaxed pl-6", children: [
                "If Only Pals were a person, she'd be a pediatrician who moonlights as a kindergarten teacher —",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold not-italic", children: "deeply caring, quietly brilliant, and always safe." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-4 pl-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Brand Archetype — The Caregiver × The Jester" }) })
            ]
          }
        )
      }
...
function BrandIdentitySection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "identity", className: "py-24 px-4 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto space-y-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "secondary", children: "Brand Identity" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-6xl text-foreground mt-4 mb-4", children: [
        "Colors that ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary", children: "feel something." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Every design decision is emotionally intentional — built for trust, joy, and warmth." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground text-center mb-8", children: "Color Palette" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-5", children: palette.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 right-3 bg-white/25 backdrop-blur-sm rounded-lg px-2 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-bold text-white", children: color.hex }) })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `p-4 ${color.light}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-base", children: color.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-primary mt-0.5", children: color.emotion }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 leading-snug", children: color.usage })
                ] })
              ]
            },
            color.name
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-6", children: "Logo Concept" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center mb-6 relative h-24", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-20 h-20 rounded-full bg-primary/20 border-2 border-primary left-1/2 -translate-x-8 top-1/2 -translate-y-1/2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute w-20 h-20 rounded-full bg-secondary/20 border-2 border-secondary left-1/2 translate-x-0 top-1/2 -translate-y-1/2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 -translate-x-3 top-1/2 -translate-y-1/2 w-6 h-12 bg-[oklch(0.58_0.13_170)]/30 rounded-full mix-blend-multiply" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground mb-2", children: "Overlapping Circles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm leading-relaxed", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-semibold", children: "parent" }),
              ", one for ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary font-semibold", children: "child" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-4 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "primary", children: "Connection" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "secondary", children: "Unity" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "accent", children: "Trust" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-6", children: "Typography" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-semibold tracking-wide uppercase", children: "Display — Bricolage Grotesque" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-4xl text-foreground leading-tight mt-1", children: "Only Pals" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-xl text-primary mt-1", children: "Bold. Playful. Trustworthy." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-border" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-semibold tracking-wide uppercase", children: "Body — Figtree" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-foreground leading-relaxed mt-1", children: '"Safe connections start with a simple hello. Only Pals brings families together in a space built on trust and joy."' }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1", children: "Warm · Readable · Approachable" })
              ] })
            ] })
          ]
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground text-center mb-8", children: "Visual Language" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-4", children: visualGallery.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-white text-sm", children: img.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-xs", children: img.desc })
                ] })
              ]
            },
            img.src
...
function BrandJustificationSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      id: "why-us",
      ref,
      className: `py-28 px-4 bg-muted/30 transition-all duration-700 ease-out ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "secondary", children: "02 · Why Only Pals" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h2",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Parenting apps didn't." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-lg mt-4 max-w-xl mx-auto", children: "Every platform was built for someone else's problem. Only Pals was built for yours." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 mb-16 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 18, className: "text-destructive" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground uppercase tracking-wide", children: "Old Platforms" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: OLD_PLATFORMS.map((platform) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `rounded-2xl border p-5 ${platform.color} ${platform.borderColor}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: platform.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: platform.platform })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: platform.failPoints.map((fp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "li",
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 18, className: "text-secondary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground uppercase tracking-wide", children: "Only Pals" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl overflow-hidden mb-5 shadow-xl", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-4 right-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-white text-lg drop-shadow", children: `"We don't just connect kids — we protect childhood."` }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ONLY_PALS_FEATURES.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "card-warm p-4 flex items-start gap-4 bg-card hover:shadow-md transition-all duration-300",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `flex-shrink-0 mt-0.5 ${feature.color}`, children: feature.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm mb-0.5", children: feature.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: feature.desc })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    CircleCheckBig,
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground uppercase tracking-widest text-sm", children: "The Numbers Don't Lie" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-5", children: STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: stat.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-snug", children: stat.label })
              ]
            },
            stat.value
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(135deg, oklch(0.6 0.2 13 / 0.12) 0%, oklch(0.58 0.13 170 / 0.10) 50%, oklch(0.72 0.15 245 / 0.10) 100%)",
              border: "1px solid oklch(0.6 0.2 13 / 0.15)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-secondary to-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-muted-foreground uppercase tracking-widest text-xs mb-3", children: "Cultural Shift" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "They're afraid of the wrong technology." })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-lg mx-auto mb-6 leading-relaxed", children: "This generation researches every product their child touches. They demand transparency, safety certifications, and emotional alignment — before they'll hand their child's world to any platform." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=1400&q=80')"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(160deg, oklch(0.18 0.12 13 / 0.92) 0%, oklch(0.14 0.08 170 / 0.88) 60%, oklch(0.10 0.05 245 / 0.95) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ref: headingRef,
                  ...
                  "h2",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          style: {
                            background: "linear-gradient(90deg, oklch(0.78 0.18 30), oklch(0.72 0.15 60))",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              ref: subRef,
              className: `transition-all duration-700 delay-200 ${subVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Only Pals exists so that no child ever feels invisible in a world full of noise."
                }
              )
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            {
              ref: ctaRef,
              className: `transition-all duration-700 delay-400 flex flex-col items-center gap-8 ${ctaVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    onClick: () => {
                      var _a2;
                      (_a2 = document.getElementById("hero")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
                    },
                    children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 mt-4 opacity-70", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: "Only Pals · Trust First"
                    }
                  )
                ] })
              ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to bottom, transparent, oklch(0.10 0.05 245 / 0.8))"
            }
          }
        )
      ]
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0",
            style: {
              background: "linear-gradient(135deg, oklch(0.38 0.2 13 / 0.82) 0%, oklch(0.35 0.15 13 / 0.75) 40%, oklch(0.32 0.13 170 / 0.80) 75%, oklch(0.28 0.13 170 / 0.88) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            ref,
            className: `relative z-10 text-center px-6 max-w-4xl mx-auto transition-all duration-1000 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Find Your Pal."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 mb-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-base md:text-lg font-body", children: "Every child deserves to be truly understood." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-base md:text-lg font-body", children: "Every parent deserves to feel safe letting them grow." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-base md:text-lg font-body font-semibold", children: "This is where real connections begin." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/15 backdrop-blur-sm border border-white/30 text-white text-sm font-semibold", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary flex-shrink-0" }),
                      "Campaign Name: ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "FOUND" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/15 backdrop-blur-sm border border-white/30 text-white text-sm font-semibold", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-secondary flex-shrink-0" }),
                      "Tagline: ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Find Your Pal." })
                    ] })
                  ]
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 opacity-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs tracking-widest uppercase font-semibold", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-white/50 animate-pulse" })
        ] })
      ]
    }
  );
...
function HeroSection() {
  const [gradientIndex, setGradientIndex] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-black/10 via-transparent to-black/30 pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-white/5 blur-3xl pointer-events-none" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `relative z-10 w-full max-w-[1200px] mx-auto px-4 pt-28 pb-16 flex flex-col items-center text-center transition-all duration-1000 ease-out ${titleVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm text-white rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-widest mb-6 border border-white/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 12, className: "text-white" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-white/80 text-lg md:text-xl max-w-xl mx-auto mb-10 leading-relaxed", children: "A trust-first playdate and emotional connection platform for children and parents." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-center gap-4 mb-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: "See the Campaign"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-3 mb-14", children: TRUST_BADGES.map(({ icon: Icon2, label, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-2 rounded-3xl bg-white/20 blur-xl -z-10" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-32 rounded-b-3xl bg-gradient-to-t from-black/30 to-transparent pointer-events-none" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 left-6 bg-white/90 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg hidden sm:block", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-xl", children: "10M+" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Families to connect" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 right-6 bg-white/90 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-lg hidden sm:block", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-xl", children: "100%" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Trust-verified" })
                    ] })
                  ]
                }
              ),
...
function LaunchPlanSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "launch", className: "py-20 px-4 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "accent", children: "Product Launch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4 mb-3", children: "Launch Plan" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "A three-phase rollout designed to build anticipation, explode on Day 0, and sustain momentum." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block absolute top-16 left-0 right-0 h-0.5 bg-gradient-to-r from-[oklch(0.6_0.2_13)] via-[oklch(0.58_0.13_170)] to-[oklch(0.72_0.15_245)] mx-20 z-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-8 relative z-10", children: phases.map((phase) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-2 bg-gradient-to-r ${phase.gradient}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center pt-7 pb-4 px-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `w-14 h-14 rounded-full bg-gradient-to-br ${phase.gradient} flex items-center justify-center shadow-lg mb-4`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-white", children: phase.number })
                }
              ),
              phase.isHero ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-3xl text-foreground", children: "LAUNCH DAY" })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: phase.dateRange
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground", children: phase.name })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-7 flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: phase.steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-muted-foreground leading-relaxed flex items-start gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base shrink-0", children: s.icon }),
                s.text
              ] })
            ] }, s.text)) }) })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid grid-cols-2 md:grid-cols-4 gap-4", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: stat.emoji }),
...
function MarketingStrategySection() {
  const [openItem, setOpenItem] = reactExports.useState("digital");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "strategy", className: "py-20 px-4 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "primary", children: "Marketing Strategy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4 mb-3 leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl mr-2", children: "₹" }),
        "10 Crore Campaign Budget"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "A multi-channel approach that meets parents where they are — online, offline, and in community." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-8 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 card-warm p-6 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-base mb-5", children: "Budget Allocation" }),
        pillars$1.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: p.emoji }),
              " ",
              p.label
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-right", children: p.budget })
        ] }, p.id))
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Accordion,
        {
          ...
          className: "space-y-3",
          children: pillars$1.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            AccordionItem,
            {
              value: p.id,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "px-5 py-4 hover:no-underline", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-1 text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: p.emoji }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-base", children: p.label }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "px-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mt-1", children: p.tactics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg mt-0.5 shrink-0", children: t.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground leading-relaxed", children: t.text })
                ] }, t.text)) }) })
              ]
            },
            p.id
...
function PRCampaignsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "pr", className: "py-20 px-4 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "secondary", children: "PR Campaigns" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4 mb-3", children: "Campaigns That Move Hearts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto", children: "Three big ideas built to spark national conversation, earn media, and create emotional impact." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-7", children: campaigns.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-52 overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-white gap-2 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl drop-shadow-lg", children: c.emoji }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 space-y-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground leading-snug", children: c.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground italic leading-relaxed", children: [
              '"',
              c.tagline,
              '"'
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 pt-1", children: c.tactics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base shrink-0 mt-0.5", children: t.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground leading-snug", children: t.text })
            ] }, t.text)) })
          ] })
        ]
      },
...
function PillarCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      "data-ocid": `trust-pillar-${index2}`,
      className: `relative flex flex-col items-center text-center rounded-3xl border-2 ${pillar.border} ${pillar.bg} p-8 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground mb-4", children: pillar.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-left w-full", children: pillar.points.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  role: "img",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Check" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "path",
                      {
                        d: "M2 6l3 3 5-5",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground leading-snug", children: pt })
        ] }, pt)) })
      ]
    }
  );
...
function TrustFrameworkSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "trust", className: "py-0 px-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "py-24 px-4",
      style: {
        background: "linear-gradient(160deg, oklch(0.99 0.01 13) 0%, oklch(0.97 0.02 60) 40%, oklch(0.98 0.01 170) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "primary", children: "Trust & Safety" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-4xl md:text-5xl lg:text-6xl text-foreground leading-tight", children: [
            "Safety isn't a feature.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "It's our foundation." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-xl mx-auto mt-4", children: "Every layer of Only Pals is built with one purpose — to keep your child safe, your data private, and your trust intact." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-3 rounded-full bg-white border-2 border-primary/20 shadow-lg", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🏅" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-sm", children: "4-Layer Protection Framework" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🏅" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: pillars.map((pillar, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PillarCard, { pillar, index: i }, pillar.title)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 flex flex-wrap justify-center gap-6 text-center", children: [
...
const PAIN_POINTS = [
  {
    ...
    description: "1 in 3 children report having no close friend at school. Screens replaced swings.",
    type: "emotional"
  },
  {
    emoji: "🔒",
    title: "Unsafe Online Spaces",
    description: "82% of parents fear child safety in social apps. No platform built trust-first.",
    type: "functional"
  },
  {
    emoji: "🎭",
    title: "Superficial Connections",
    description: "Kids collect followers, not friends. Likes replaced genuine belonging.",
    type: "emotional"
  },
  {
    emoji: "🔑",
    title: "Verification Gap",
    description: "Zero platforms verify parent identity before connecting families.",
    type: "functional"
  },
  {
    emoji: "📱",
    title: "Screen Addiction Risk",
    description: "Average child spends 7+ hrs on screens. Meaningful connection = less than 45 mins.",
    type: "ethical"
  },
  {
    emoji: "🌐",
    title: "Data Privacy Neglect",
    description: "Children's data sold, harvested, monetized. COPPA barely enforced. Parents blindsided.",
    type: "ethical"
  }
];
const VALUES = [
  {
    icon: "🛡️",
    title: "Trust-First",
    description: "Every interaction verified. Every profile parent-approved. Safety is the product, not an afterthought.",
    color: "bg-primary/8"
  },
  {
    icon: "🌱",
    title: "Authentic Growth",
    description: "Real friendships, real play, real emotional development. No filters, no pretend.",
    color: "bg-secondary/8"
  },
  {
    icon: "🤝",
    title: "Community Care",
    description: "Built with parents, pediatricians, educators. Your village, digitally enabled.",
    color: "bg-accent/8"
  },
  {
    icon: "🔐",
    title: "Privacy Sacred",
    description: "No ads. No selling data. No tracking. Children's information stays children's information.",
    color: "bg-[oklch(0.68_0.18_60)]/8"
  },
  {
    icon: "💛",
    title: "Emotional Intelligence",
    description: "We measure connection quality, not follower count. Empathy is our algorithm.",
    color: "bg-primary/8"
  }
];
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrandJustificationSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "mission", className: "py-24 px-4 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "accent", children: "03 · Mission, Vision & Values" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4", children: "What We Believe In" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-warm p-8 bg-accent/5 border-accent/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🎯" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl text-accent", children: "Our Mission" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground leading-relaxed", children: "To build a verified, emotionally intelligent platform where parents can confidently connect their children for safe, meaningful, in-person friendships." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-warm p-8 bg-primary/5 border-primary/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "🌅" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl text-primary", children: "Our Vision" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-foreground leading-relaxed", children: "A world where every child has at least one genuine friend outside their school gate — and every parent feels safe making that happen." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: VALUES.map((v) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `card-warm p-6 ${v.color}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl block mb-3", children: v.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground mb-2", children: v.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: v.description })
      ] }, v.title)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "problem", className: "py-24 px-4 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "primary", children: "04 · Problem Identification" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4 mb-4", children: "The Crisis No One Is Solving" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 items-center mb-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: PAIN_POINTS.slice(0, 4).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "card-warm p-5 flex gap-4 items-start",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl flex-shrink-0", children: p.emoji }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: p.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-xs px-2 py-0.5 rounded-full font-medium ${p.type === "emotional" ? "bg-primary/10 text-primary" : p.type === "functional" ? "bg-secondary/10 text-secondary" : "bg-accent/10 text-accent"}`,
                      children: p.type
                    }
                  )
                ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-5", children: PAIN_POINTS.slice(4).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "card-warm p-5 flex gap-4 items-start",
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: p.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-accent/10 text-accent text-xs px-2 py-0.5 rounded-full font-medium", children: p.type })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: p.description })
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "insight", className: "py-24 px-4 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "warm", children: "05 · Consumer Insight" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4 mb-16", children: "The One Truth That Changes Everything" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-8", children: [
        {
          ...
          context: "There are 47 parenting apps in India. None of them have solved the core problem: a parent cannot confidently hand their child to a stranger, no matter how many stars their profile has.",
          color: "border-l-4 border-primary bg-primary/5"
        },
        {
          insight: `"Children don't need more content — they need someone to play with."`,
          context: "Every algorithm optimizes for watch time. Only Pals optimizes for friendship time. The shift from consumption to connection is the biggest whitespace in child technology.",
          color: "border-l-4 border-secondary bg-secondary/5"
        }
      ].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `card-warm p-10 text-left ${i.color}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-2xl text-foreground mb-4 italic leading-snug", children: i.insight }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: i.context })
          ]
        },
        i.insight
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "audience", className: "py-24 px-4 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, { color: "secondary", children: "06 · STP Framework" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-4xl md:text-5xl text-foreground mt-4", children: "Who We Talk To" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        ].map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `card-warm p-5 ${a.color}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: a.badge.split(" ")[0] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: a.label })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: a.desc })
        ] }, a.label)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-warm p-10 bg-gradient-to-br from-primary/8 via-secondary/5 to-accent/8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-xl text-muted-foreground mb-2", children: "Positioning Statement" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-2xl md:text-3xl text-foreground leading-relaxed", children: [
          '"For ',
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "trust-conscious parents" }),
          " ",
          "in urban India,",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
          "Only Pals is the",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary", children: "verified friendship platform" }),
          " ",
          "that",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "hidden md:block" }),
          "unlike ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "social media" }),
          ', which was never built for children."'
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrandAvatarSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BrandIdentitySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CoreCampaignSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MarketingStrategySection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(PRCampaignsSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(LaunchPlanSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(TrustFrameworkSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "community-visual", className: "py-0 px-0 bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1200px] mx-auto px-4 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConclusionSection, {})
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) }),
